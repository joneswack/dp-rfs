...
configs = [
    ...
    {'name': 'Maclaurin using $k_p$ with $p=9$', 'method': 'maclaurin', 'proj': 'rademacher', 'degree': 15, 'hierarchical': False, 'complex_weights': False, 'complex_real': False, 'single_cluster': True},
    {'name': 'Maclaurin using $k_p^*$ with $p=9$ (this work)', 'method': 'maclaurin', 'proj': 'rademacher', 'degree': 15, 'hierarchical': False, 'complex_weights': False, 'complex_real': False},
]
